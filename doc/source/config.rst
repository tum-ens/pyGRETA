...
.. automodule:: config
   :members: config, general_settings, scope_paths_and_parameters
   
.. NOTE:: Both param and paths will be updated in the code after running the function :func: config in ``config.py``.
