...
merra_cut_energy = gwa_cut / np.sum(gwa_cut) * E
merra_cut = np.cbrt(merra_cut * Num_pix)  # Convert back from energy to wind speed
reMerra[i_offset:i_offset + K_last + 1 - K_first, j_offset:j_offset + L_last + 1 - L_first, :8760] = merra_cut
