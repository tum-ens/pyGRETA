...
The intersection between IRENA and EMHIRES region list is first determined. Based on that list, the regions are extracted from the TS files.
...
This means that the decimal separator in the .csv file might have to be changed manually from a point ('.') to a comma (',') or vice versa.
